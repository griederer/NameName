...
describe('Card Components', () => {
  describe('Card', () => {
    ...
    it('forwards additional props', () => {
      render(<Card id="test-card" data-custom="value" data-testid="card">Test</Card>);
      const card = screen.getByTestId('card');
  ...
  describe('CardHeader', () => {
    ...
    it('accepts custom className', () => {
      render(<CardHeader className="custom-header" data-testid="header">Test</CardHeader>);
      const header = screen.getByTestId('header');
  ...
  describe('CardTitle', () => {
    ...
    it('accepts custom className', () => {
      render(<CardTitle className="custom-title" data-testid="title">Test</CardTitle>);
      const title = screen.getByTestId('title');
  ...
  describe('CardDescription', () => {
    ...
    it('accepts custom className', () => {
      render(<CardDescription className="custom-desc" data-testid="description">Test</CardDescription>);
      const description = screen.getByTestId('description');
  ...
  describe('CardContent', () => {
    ...
    it('accepts custom className', () => {
      render(<CardContent className="custom-content" data-testid="content">Test</CardContent>);
      const content = screen.getByTestId('content');
  ...
  describe('CardFooter', () => {
    ...
    it('accepts custom className', () => {
      render(<CardFooter className="custom-footer" data-testid="footer">Test</CardFooter>);
      const footer = screen.getByTestId('footer');
