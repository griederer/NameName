...
describe('Icon Components', () => {
  ...
  describe('Props Forwarding', () => {
    it('forwards additional SVG props', () => {
      render(
        <div>
          <BabyIcon data-testid="baby" id="baby-icon" role="img" aria-label="Baby" />
          <ChatIcon data-testid="chat" id="chat-icon" role="img" aria-label="Chat" />
          <SendIcon data-testid="send" id="send-icon" role="img" aria-label="Send" />
        </div>,
      )
